                        ...
                        <div class="title-box text-center">
                            <div class="content-wrapper">
                                ...
                                <p class="text title-box-text">
                                    Lihat dan cek pengumuman seputar Kesehatan serta kegiatan desa. Smarthealth menyediakan berbagai berita kesehatan yang Up to Date.
                                </p>
                            </div>
                        </div>
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/images/artikel/corouselpengumuman1.jpg" class="d-block w-90" style="max-width: 65%;" alt="...">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Vaksinasi dan Imunisasi Gratis</h5>
                                            <p>Lindungi diri dan keluarga Anda dari berbagai penyakit</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/images/artikel/corouselpengumuman2.jpg" class="d-block w-90" style="max-width: 65%;" alt="...">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Predikat Puskesmas Terbaik</h5>
                                            <p>Puskesmas Sidoarjo Raih Predikat Puskesmas Terbaik 2024</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/images/artikel/corouselpengumuman3.jpg" class="d-block w-90" style="max-width: 65%;" alt="...">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Cegah Stunting Sejak Dini</h5>
                                            <p>Cukupi Gizi Anak Anda, Kesehatan anak masa depan bangsa</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <section id="artikel" class="sc-articles">
                ...
                <div class="container">
                    <div class="articles-content">
                        ...
                        <div class="title-box text-center">
                            <div class="content-wrapper">
                                <h5 class="title-box-name">Berita dan Pengumuman Terbaru</h5>
                                <div class="title-separator mx-auto"></div>
                            </div>
                        </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            ...
                            if (mysqli_num_rows($hasil) > 0) {
                                while ($row = mysqli_fetch_assoc($hasil)) {
                                    $shortText = truncateText($row["ISI_PENGUMUMAN"], 15);
                            ...
                            ?>
                                    <div class="col">
                                        <div class="card">
                                            <?php echo $imageHTML; ?>
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo $row["JUDUL_PENGUMUMAN"]; ?></h5>
                                                <p class="card-text"><?php echo htmlspecialchars($shortText); ?></p>
                                                <a href="pengumuman-detail.php?id=<?php echo $row['ID_PENGUMUMAN']; ?>" class="item-link text-blue d-flex align-items-baseline">
