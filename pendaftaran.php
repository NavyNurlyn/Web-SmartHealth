                ...
                <div class="container">
                    ...
                    <div class="title-box text-center">
                        <div class="content-wrapper">
                            <h5 class="title-box-name" style="font-size: 31px;">Pendaftaran Puskesmas Sidoarjo</h5>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <div class="card" style="border-radius: 11px;">
                                <div class="card-body d-flex flex-column align-items-center text-center">
                                    ...
                                    <h5 class="card-title" style="font-size: 19px;">Daftar Antrian Online</h5>
                                    <p class="card-text" style="font-size: 14px;">Lakukan pendaftaran untuk mendapat nomor antrian</p>
                                    <div class="d-flex align-items-center justify-content-center services-main-btn" style="margin-top: 20px">
                                        <button type="button" class="btn btn-primary-outline" onclick="window.location.href='pendaftaran-pilihpuskesmas.php'">
                                            Daftar Sekarang
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <div class="card" style="border-radius: 11px;">
                                <div class="card-body d-flex flex-column align-items-center text-center">
                                    ...
                                    <h5 class="card-title" style="font-size: 19px;">Batalkan Antrian Online</h5>
                                    <p class="card-text" style="font-size: 14px;">Lihat antrian anda dan batalkan antrian online anda</p>
                                    <div class="d-flex align-items-center justify-content-center services-main-btn" style="margin-top: 20px">
                                        <button type="button" class="btn btn-primary-outline" onclick="window.location.href='batalkan-antrian.php'">
                                            Batalkan Antrian
                                        </button>
                                    </div>
                                </div>
