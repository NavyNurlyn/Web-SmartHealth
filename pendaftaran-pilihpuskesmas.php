                ...
                <div class="container">
                    ...
                    <div class="title-box text-center">
                        <div class="content-wrapper">
                            <h5 class="title-box-name" style="font-size: 31px;">Pilih Puskesmas Sidoarjo</h5>
                        ...
                        ?>
                                <div class="col">
                                    <div class="card" style="border-radius: 11px;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="font-size: 19px;"><?php echo $row["NAMA_PUSKESMAS"]; ?></h5>
                                            <p class="card-text" style="font-size: 14px;"><?php echo $row["ALAMAT_PUSKESMAS"]; ?></p>
                                            <a href="pendaftaran-pilihpoli.php?id=<?php echo $row['ID_PUSKESMAS']; ?>" class="item-link text-blue d-flex align-items-baseline">
                                                <span class="item-link-text">Daftar ke Puskesmas</span>
